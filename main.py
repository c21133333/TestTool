...
def main() -> int:
    ...
    style = [
        ...
        "QLineEdit, QTextEdit, QTableWidget, QListWidget { background-color: #ffffff; color: #111827; border: 1px solid #d1d5db; border-radius: 4px; padding: 6px; }",
        "QLineEdit { min-height: 28px; font-size: 10pt; }",
        "QTextEdit { font-family: Consolas, \"Courier New\", monospace; background-color: #ffffff; color: #111827; }",
        "QLineEdit::placeholder, QTextEdit::placeholder { color: #9ca3af; }",
